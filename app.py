...
@app.route('/')
def index():
    return "<div style='text-align:center; family-font:arial'><h1>Tarea 2 - Taller de integración</h1><img src='https://www.killyourdarlings.com.au/wp-content/uploads/2017/04/pusheen4.gif'></div>"
