...
@app.route('/')
def index():
    return "<div style='text-align:center; font-family: Arial, Helvetica, sans-serif;'><br><h1>Tarea 2 - Taller de integración</h1><br><br><img src='https://www.killyourdarlings.com.au/wp-content/uploads/2017/04/pusheen4.gif' width="100" height="auto"></div>"
